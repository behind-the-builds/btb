...
safeSetInnerHTML(0, "btb_video_header", `<div class="video-header">Observe the dashboard inclinometer as a G Wagon navigates a steep obstacle:</div>`);
safeSetInnerHTML(0, "btb_video_embed", `<iframe src="https://www.youtube.com/embed/e6T0SXa4lkc?si=SyR8_Vj-CH0cnGBh&amp;start=356&amp;end=416" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>`);
applyGridLayout();
