...
safeSetInnerHTML(0, "btb_video_header", `<div class="video-header">Watch the LEGO model designer demonstrate the model's rigid rear axle:</div>`);
safeSetInnerHTML(0, "btb_video_embed", `<iframe src="https://www.youtube.com/embed/fJawD19K5b4?si=gqBYVe4n7VSQZzeb&amp;start=332&amp;end=551" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>`);
applyGridLayout();
