...
safeSetInnerHTML(1, "btb_title", `<div class="title-container"><h1 style="white-space:pre-wrap;">Instructions 740-756: Tailgate Assembly</h1></div>`);
safeSetInnerHTML(1, "btb_icon_1", `<div class="icon-container"><i class="fas fa-tools"></i></div><div class="title-container">Heavy-Duty Tailgate</div><div class="content-container">The tailgate is built for durability, supporting essential tasks in rugged environments.</div>`);
safeSetInnerHTML(1, "btb_icon_2", `<div class="icon-container"><i class="fas fa-compass"></i></div><div class="title-container">Mission-Ready Access</div><div class="content-container">Ensures quick cargo access, valuable for rescue and special operations teams.</div>`);
...
safeSetInnerHTML(1, "btb_image", `<img src="https://behind-the-builds.github.io/btb/g500/images/KOCR_LUVW01.JPG" alt="G-Class serving in wet conditions">`);
safeSetInnerHTML(1, "btb_caption", `<div class="caption-container"><p class="sqsrte-large" style="white-space:pre-wrap;">G-Class serving in wet conditions</p></div><div class="source-container"><p class="sqsrte-large" style="white-space:pre-wrap;"><a href="https://commons.wikimedia.org/wiki/File:KOCR_LUVW01.JPG" target="_blank">source</a></p></div>`);
safeSetInnerHTML(2, "btb_title", `<div class="title-container"><h1 style="white-space:pre-wrap;">Bag 18: Roof Assembly</h1></div>`);
safeSetInnerHTML(2, "btb_icon_1", `<div class="icon-container"><i class="fas fa-globe"></i></div><div class="title-container">High Load-Bearing Roof</div><div class="content-container">Supports up to 150 kg, ideal for roof racks and equipment on rugged journeys.</div>`);
safeSetInnerHTML(2, "btb_icon_2", `<div class="icon-container"><i class="fas fa-hammer"></i></div><div class="title-container">Reinforced Durability</div><div class="content-container">Made with laser-welded steel, balancing strength and weight for off-road stability.</div>`);
...
safeSetInnerHTML(2, "btb_image", `<img src="https://behind-the-builds.github.io/btb/g500/images/153434948_f5a05344bb_o.jpg" alt="Canadian Armed Forces G-Class with loaded roof rack">`);
safeSetInnerHTML(2, "btb_caption", `<div class="caption-container"><p class="sqsrte-large" style="white-space:pre-wrap;">Canadian Armed Forces G-Class with loaded roof rack</p></div><div class="source-container"><p class="sqsrte-large" style="white-space:pre-wrap;"><a href="https://www.flickr.com/photos/squeakymarmot/153434948" target="_blank">source</a></p></div>`);
safeSetInnerHTML(3, "btb_title", `<div class="title-container"><h1 style="white-space:pre-wrap;">Instructions 757-789: Roof Assembly</h1></div>`);
safeSetInnerHTML(3, "btb_icon_1", `<div class="icon-container"><i class="fas fa-shield-alt"></i></div><div class="title-container">Military-Grade Strength</div><div class="content-container">Engineered to support both expedition gear and armored configurations for high-security use.</div>`);
safeSetInnerHTML(3, "btb_icon_2", `<div class="icon-container"><i class="fas fa-layer-group"></i></div><div class="title-container">Laser-Welded Joints</div><div class="content-container">Laser welding enhances durability and reduces weight for a stable, rugged roof design.</div>`);
...
safeSetInnerHTML(3, "btb_image", `<img src="https://behind-the-builds.github.io/btb/g500/images/Terrängbil_5_Revinge_2015-1.jpg" alt="A military G-Class outfitted for off-road conditions">`);
safeSetInnerHTML(3, "btb_caption", `<div class="caption-container"><p class="sqsrte-large" style="white-space:pre-wrap;">A military G-Class outfitted for off-road conditions</p></div><div class="source-container"><p class="sqsrte-large" style="white-space:pre-wrap;"><a href="https://commons.wikimedia.org/wiki/File:Terr%C3%A4ngbil_5_Revinge_2015-1.jpg" target="_blank">source</a></p></div>`);
hideExtraSections(3);
