...
safeSetInnerHTML("btb_icon_1_1", `<div class="icon-container"><i class="fas fa-tachometer-alt"></i></div><div class="title-container">Inline-Six Power</div><div class="content-container">The new G500 features a turbocharged inline-six for enhanced performance and efficiency.</div>`);
safeSetInnerHTML("btb_icon_1_2", `<div class="icon-container"><i class="fas fa-cogs"></i></div><div class="title-container">Engine Components</div><div class="content-container">The model represents key engine parts like cylinder heads and valve covers.</div>`);
