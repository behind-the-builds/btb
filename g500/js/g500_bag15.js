...
safeSetInnerHTML(1, "btb_title", `<div class="title-container"><h1 style="white-space:pre-wrap;">Bag 15: Front Wheel Wells, Headlights, and Rear Bumper</h1></div>`);
safeSetInnerHTML(1, "btb_icon_1", `<div class="icon-container"><i class="fas fa-wrench"></i></div><div class="title-container">Functional Design</div><div class="content-container">Designed with off-road adaptability, allowing extra suspension room for smooth operation.</div>`);
safeSetInnerHTML(1, "btb_icon_2", `<div class="icon-container"><i class="fas fa-car"></i></div><div class="title-container">Classic G-Class Style</div><div class="content-container">Signature features echo the G-Class’s durable military origins and modern luxury.</div>`);
