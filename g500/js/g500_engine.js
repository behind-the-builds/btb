...
safeSetInnerHTML(0, "btb_video_header", `<div class="video-header">Watch an animation of the M256 engine used in the 2025 G500:</div>`);
safeSetInnerHTML(0, "btb_video_embed", `<iframe src="https://www.youtube.com/embed/wKz58vLmoyc?si=TV5TlXnyi_KllzFn&amp;start=5" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>`);
applyGridLayout();
