...
safeSetInnerHTML(1, "btb_title", `<div class="title-container"><h1 style="white-space:pre-wrap;">Bag 12: Dashboard</h1></div>`);
...
safeSetInnerHTML(1, "btb_maintext", `<p class="sqsrte-large" style="white-space:pre-wrap;">In Bag 12, we focus on constructing the <strong>dashboard</strong>, including the dashboard frame and windshield wipers of the G-Class model.</p><p class="sqsrte-large" style="white-space:pre-wrap;">The evolution of dashboard controls in vehicles like the G-Class reflects significant advancements in automotive technology. Early models featured basic instrumentation with analog gauges that displayed speed, fuel level, and engine temperature. As technology progressed, dashboards became more sophisticated, integrating digital displays, advanced infotainment systems, and in the G500 details helpful in off-road maneuvers. The introduction of features such as navigation systems, climate control interfaces, and multimedia connectivity transformed dashboards into multifunctional command centers.</p>`);
