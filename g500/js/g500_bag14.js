...
safeSetInnerHTML(1, "btb_icon_1", `<div class="icon-container"><i class="fas fa-wrench"></i></div><div class="title-container">Functional Hinges</div><div class="content-container">Hood hinges allow easy access to the engine compartment for maintenance.</div>`);
