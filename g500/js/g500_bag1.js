...
safeSetInnerHTML(1, "btb_title", `<div class="title-container"><h1 style="white-space:pre-wrap;">Bag 1: Front Differential and Drivetrain</h1></div>`);
...
safeSetInnerHTML(2, "btb_image", `<img src="https://behind-the-builds.github.io/btb/g500/images/Differential_Gear_(PSF).jpg" alt="A diagram of a differential gear">`);
...
safeSetInnerHTML(3, "btb_title", `<div class="title-container"><h1 style="white-space:pre-wrap;">Instructions 9-16: Front Hubs and Suspension</h1></div>`);
safeSetInnerHTML(3, "btb_icon_1", `<div class="icon-container"><i class="fas fa-cog"></i></div><div class="title-container">Independent Front Suspension</div><div class="content-container">Introduced in 2019, aiming to improve on-road comfort and handling while maintaining off-road capability.</div>`);
safeSetInnerHTML(3, "btb_icon_2", `<div class="icon-container"><i class="fas fa-car"></i></div><div class="title-container">Design Trade-offs</div><div class="content-container">The new suspension offers better articulation, but some argue it may compromise extreme off-road performance.</div>`);
...
safeSetInnerHTML(3, "btb_image", `<img src="https://behind-the-builds.github.io/btb/g500/images/Off-RoadPreparation.jpg" alt="A G500 off road">`);
...
safeSetInnerHTML(4, "btb_title", `<div class="title-container"><h1 style="white-space:pre-wrap;">Instructions 20-31: Steering System</h1></div>`);
safeSetInnerHTML(4, "btb_icon_1", `<div class="icon-container"><i class="fas fa-cog"></i></div><div class="title-container">Steering Evolution</div><div class="content-container">G-Class transitioned from recirculating ball to rack and pinion steering in 2019, improving on-road handling.</div>`);
safeSetInnerHTML(4, "btb_icon_2", `<div class="icon-container"><i class="fas fa-car"></i></div><div class="title-container">Off-Road to On-Road</div><div class="content-container">The new steering system balances the G-Class's legendary off-road prowess with improved everyday drivability.</div>`);
...
safeSetInnerHTML(4, "btb_image", `<img src="https://behind-the-builds.github.io/btb/g500/images/RecirculatingBall.jpg" alt="Recirculating ball steering system">`);
