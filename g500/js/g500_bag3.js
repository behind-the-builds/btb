...
safeSetInnerHTML(1, "btb_title", `<div class="title-container"><h1 style="white-space:pre-wrap;">Bag 3: Center Differential and Transmission</h1></div>`);
...
safeSetInnerHTML(1, "btb_maintext", `<p class="sqsrte-large" style="white-space:pre-wrap;">In <strong>Bag 3</strong>, we assemble the <strong>center differential</strong> and <strong>transmission</strong> of the G500 model, both crucial elements that manage power distribution and vehicle control. The <strong>center differential</strong> plays a key role in the G-Class's legendary off-road ability by dividing engine power between the front and rear axles, allowing wheels to rotate at different speeds. This capability is essential when navigating uneven terrain, as it prevents wheel slippage and ensures that traction is maintained across all four wheels.</p><p class="sqsrte-large" style="white-space:pre-wrap;">The <strong>transmission</strong>, or gearbox, manages the engine's power output to provide the right balance of speed and torque for each driving situation. In the G-Class, the transmission is engineered for versatility, providing low-range gears for off-road power and high-range gears for efficient highway cruising. Together, the center differential and gearbox allow the G500 to adapt to a wide variety of terrains and conditions, balancing power and control in any environment.</p>`);
safeSetInnerHTML(1, "btb_video_header", `<div class="video-header">Watch a real-world demonstration of the G500's triple locking differential:</div>`);
safeSetInnerHTML(1, "btb_video_embed", `<iframe src="https://www.youtube.com/embed/oo3wqq4WRys?si=O290SKtboBcTq9j9" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>`);
...
safeSetInnerHTML(3, "btb_image", `<img src="https://behind-the-builds.github.io/btb/g500/images/Mercedes-Benz_9-G-TRONIC-Hybrid_0.jpg" alt="The transmission used in the G500 (Thilo Parg, License: CC BY-SA 4.0, via Wikimedia Commons)">`);
safeSetInnerHTML(3, "btb_caption", `<div class="caption-container" style="text-align: center;"><p class="sqsrte-medium" style="white-space:pre-wrap;">The transmission used in the G500 (Thilo Parg, License: CC BY-SA 4.0, via Wikimedia Commons)</p></div><div class="source-container" style="text-align: center;"><p class="sqsrte-medium" style="white-space:pre-wrap;"><a href="https://commons.wikimedia.org/wiki/File:Mercedes-Benz_9-G-TRONIC-Hybrid_0.jpg" target="_blank" style="color: #0073e6; text-decoration: underline;">source</a></p></div>`);
