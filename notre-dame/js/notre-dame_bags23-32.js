...
safeSetInnerHTML(1, "btb_title", `<div class="title-container"><h1 style="white-space:pre-wrap;">Bags 23-32: Western Towers, Nave and Transept Roofs</h1></div>`);
...
safeSetInnerHTML(4, "btb_title", `<div class="title-container"><h1 style="white-space:pre-wrap;">Instructions 289-299: Base of the Bell Chambers and the Grande Galerie</h1></div>`);
...
safeSetInnerHTML(8, "btb_title", `<div class="title-container"><h1 style="white-space:pre-wrap;">Instructions 350-369 Oculus Windows and Transept Portal Roof</h1></div>`);
