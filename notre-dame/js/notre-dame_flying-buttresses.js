...
safeSetInnerHTML(0, "btb_video_header", `<div class="video-header">Watch a description of how flying buttresses support the towering inner spaces:</div>`);
safeSetInnerHTML(0, "btb_video_embed", `<iframe src="https://www.youtube.com/embed/Hijg5XG6yg8?si=LZ8ZBST0xwz69_La&amp;start=80&amp;end=108" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>`);
applyGridLayout();
