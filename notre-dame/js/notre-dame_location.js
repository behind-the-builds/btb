...
safeSetInnerHTML(0, "btb_video_header", `<div class="video-header">Watch a short discussion of Notre-Dame's central location on the Île de la Cité</div>`);
safeSetInnerHTML(0, "btb_video_embed", `<iframe src="https://www.youtube.com/embed/Hijg5XG6yg8?si=kcoIBP0mDAFZuHVo&amp;start=6&amp;end=56" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>`);
applyGridLayout();
