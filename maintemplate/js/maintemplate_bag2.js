...
safeSetInnerHTML(2, "btb_video_header", `<div class="video-header">Watch the model designer demonstrate the Ackermann steering implementation:</div>`);
safeSetInnerHTML(2, "btb_video_embed", `<iframe width="560" height="315" src="https://www.youtube.com/embed/fJawD19K5b4?si=Go5zRdZMJKlQb_a1&amp;start=488&amp;end=512" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>`);
