...
safeSetInnerHTML(0, "btb_video_header", `<div class="video-header">Watch the LEGO model designer demonstrate the working winch:</div>`);
safeSetInnerHTML(0, "btb_video_embed", `<iframe src="https://www.youtube.com/embed/p3DPvbhjX-M?si=3mKdgl025DaE8s52&amp;start=199&amp;end=225" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>`);
applyGridLayout();
