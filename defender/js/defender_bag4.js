...
safeSetInnerHTML(7, "btb_icon_1", `<div class="icon-container"><i class="fas fa-mountain"></i></div><div class="title-container">Expedition Ready</div><div class="content-container">Built from anodized aluminum, the roof rack can withstand rugged conditions without added weight.</div>`);
...
safeSetInnerHTML(9, "btb_icon_1", `<div class="icon-container"><i class="fas fa-road"></i></div><div class="title-container">Traction Recovery</div><div class="content-container">Recovery tracks provide grip in mud, sand, and snow, helping the Defender escape difficult conditions.</div>`);
