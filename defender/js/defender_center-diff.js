...
safeSetInnerHTML(0, "btb_video_header", `<div class="video-header">Watch a Defender driver lock the center differential to overcome an obstacle:</div>`);
safeSetInnerHTML(0, "btb_video_embed", `<iframe src="https://www.youtube.com/embed/6VlKZ4VxDAM?si=LuoBquL_tYVx6DUF&amp;start=5&amp;end=30" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>`);
applyGridLayout();
