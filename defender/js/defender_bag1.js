...
safeSetInnerHTML(2, "btb_video_header", `<div class="video-header">Watch the Defender's rear differential in action</div>`);
safeSetInnerHTML(2, "btb_video_embed", `<iframe src="https://www.youtube.com/embed/4fu4GmzpFmA?si=xYQdMLNBmPfnV3Bh&amp;start=148" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>`);
...
safeSetInnerHTML(3, "btb_video_header", `<div class="video-header">Watch a Defender navigate a muddy rutted road during a Camel Trophy event in the 1980s:</div>`);
safeSetInnerHTML(3, "btb_video_embed", `<iframe src="https://www.youtube.com/embed/QtK_jnqGaLg?si=xWmQF0MUtCGpEChn&amp;start=148&amp;end=264" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>`);
